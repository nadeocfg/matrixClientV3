...
export const ArrowDownIcon = ({ color = '#38383A' }: IconProps) => {
  return (
    <Svg width="24" height="24" viewBox="0 0 24 24" fill="none">
      <Path
        d="M11.583 16.1768C11.8433 16.1768 12.0591 16.0815 12.2622 15.8784L17.042 10.9907C17.207 10.8257 17.2832 10.6289 17.2832 10.394C17.2832 9.91797 16.9087 9.53076 16.4326 9.53076C16.1978 9.53076 15.9819 9.63232 15.8105 9.80371L11.5894 14.1455L7.35547 9.80371C7.18408 9.63232 6.97461 9.53076 6.7334 9.53076C6.25732 9.53076 5.87646 9.91797 5.87646 10.394C5.87646 10.6289 5.95898 10.8257 6.12402 10.9907L10.9038 15.8784C11.1069 16.0879 11.3228 16.1768 11.583 16.1768Z"
        fill={color}
      />
    </Svg>
  );
